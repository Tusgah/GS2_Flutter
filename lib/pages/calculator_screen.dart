...
import 'package:macros_amounts/bloc/macro_bloc.dart';
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: BlocProvider(
              ...
              child: BlocConsumer<MacroBloc, MacroState>(
                builder: (context, state) {
                  ...
                  return CalculatorPage(
                    ...
                    onCalculatePressed: () async {
                      context.read<MacroBloc>().add(GetMacroEvent(
                            gender: gender,
                ...
                listener: (context, state) {
                  if (state is MacroSuccess) {
                    showMacrosDialog(
                      context,
                      data: state.data,
                    );
                  }
                  if (state is MacroError) {
